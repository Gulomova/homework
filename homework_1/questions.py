...
# Напишите программу, которая найдет все такие числа, которые делятся на 7, но не кратны 5, между 2000 и 3200
# (оба включены).
# Полученные числа должны быть напечатаны через запятую в одной строке.
#
# подсказки:
# Рассмотрим использование диапазона (#begin, #end) метод
# ===============================================================================================================
...
# Напишите программу, которая может вычислить факториал заданных чисел.
# Результаты должны быть напечатаны через запятую в одной строке.
...
# С заданным целым числом n напишите программу для создания словаря, который содержит (i, i * i) такой, что это целое
# число от 1 до n (оба включены). и тогда программа должна напечатать словарь.
# Предположим, что в программу введены следующие данные:
# 8
#
# Тогда вывод должен быть:
